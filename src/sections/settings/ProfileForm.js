...
const ProfileForm = () => {
  ...
  const ProfileSchemaForm = Yup.object().shape({
  ...
  const methods = useForm({
    resolver: yupResolver(ProfileSchemaForm),
    defaultValues,
  });
    ...
    <FormProvider methods={methods} onSubmit={handleSubmit(onSubmit)}>
        <Stack spacing={3}>
            <Stack spacing={3}>
                ...
                <RHFTextField name="name" label="Your Name" helperText='This name is visible to your contacts.'/>
