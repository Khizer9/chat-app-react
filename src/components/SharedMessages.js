...
import { Box, IconButton, Stack, Tab, Typography, Tabs, Grid } from '@mui/material'
...
import { DocMsgs, LinkMsgs } from './Conversation/MsgTypes'
             ...
             spacing={value === 1 ? 1 : 3}>
                {(() => {
                    switch (value) {
                        ...
                        case 1:
                            // Links
                            return SHARED_LINKS.map((el) => <LinkMsgs el={el}/>)
                        case 2:
                            // Docs
                            return SHARED_DOCS.map((el) => <DocMsgs el={el}/>)
