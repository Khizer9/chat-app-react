...
const ChatInput = ({setOpenPicker}) => {
  ...
  return (
            <StyleInput fullWidth placeholder='Write a message....' variant='filled' InputProps={{
                 ...
                 ( <Stack sx={{width:'max-content'}}>
                    ...
                    <InputAdornment>
                      <IconButton onClick={() => setOpenAction((prevState) => !prevState)}>
                        <LinkSimple />
                      </IconButton>
                    </InputAdornment>
                  </Stack>
                  ...
                  <IconButton onClick={() => setOpenPicker((prevState) => !prevState)}>
                    <Smiley />
                  </IconButton>
                </InputAdornment>,
                }} />
